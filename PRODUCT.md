...
- Header color theme: 기본 (tangerine magnet), 현무암 (basalt magnet). Look glass|library (default glass; a stored fridge reads as glass) remaps enamel tokens only in library. Language, Look, palette, appearance, and Leave sit on `/settings`.
